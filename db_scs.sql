...
--
-- Host: localhost
-- Generation Time: 03-Dez-2015 às 01:26
...
(7, 'Rua Yayá', '2666', '', 'Canhema', 'Diadema', 'SP', '09941445'),
(8, 'Rua Dias de Almeida', '5', '', 'Jardim Miriam', 'São Paulo', 'SP', '04419000'),
(9, 'Rua Yayá', '555', '', 'Canhema', 'Diadema', 'SP', '09941445'),
(10, 'Rua Yayá', '2312', '', 'Canhema', 'Diadema', 'SP', '09941445');
...
(7, 'XZCZXZCCZC', 'SDASDASDASDADASDASD', '55555555555552', '55555', '555555555555', 7, 7),
(8, '55', '55', '55555555555555', '55555', '555555555555', 8, 8),
(9, 'ASDASDSDASD', 'SDASDASDASDASD', '65659898989898', '98989', '898989898989', 9, 9),
(10, 'SADASDASD', 'SDASDASD', '42354543552334', '12313', '121321321312', 10, 10);
...
(1, 'ASD', 6, '555.55', '2014-11-30', 0, '55555.00', '555.55', '9999.90'),
(2, 'ASD', 6, '10.00', '2015-01-20', 0, '2000.00', '20.00', '360.00'),
(3, 'QWE', 6, '5.55', '1111-11-11', 9497, '55500.00', '555.00', '9990.00'),
(4, 'QWEQWEQWE', 8, '500.00', '2015-11-06', 0, '50000.00', '500.00', '9000.00'),
(5, 'ASD', 6, '0.50', '2015-01-19', 40, '50.00', '0.50', '9.00'),
(6, '23213', 6, '23.13', '1997-11-25', 5000, '115650.00', '1156.50', '20817.00');
...
INSERT INTO `venda` (`VenCod`, `VenPro`, `VenQtd`, `VenDat`, `VenVun`, `VenVto`) VALUES
(0, 'ASD', 50, '2015-12-01', '100.00', '5000.00'),
(1, 'ASD', 100, '2015-12-02', '500.00', '50000.00'),
(2, 'QWEQWEQWE', 100, '2011-12-03', '0.02', '2.00'),
(3, 'QWE', 1, '1111-11-11', '0.11', '0.11'),
(4, 'ASD', 100, '5155-12-11', '50.00', '5000.00'),
(5, 'ASD', 10, '1111-11-11', '0.01', '0.10'),
(6, 'QWE', 500, '1111-11-11', '0.01', '5.00');
...
--
-- Extraindo dados da tabela `vendaueps`
--

INSERT INTO `vendaueps` (`VenCod`, `VenPro`, `VenQtd`, `VenDat`, `VenVun`, `VenVto`) VALUES
(0, 'ASD', 100, '2012-12-02', '50.00', '5000.00'),
(1, 'QWE', 1, '1111-11-11', '50.00', '50.00'),
(2, 'QWE', 1, '1111-11-11', '50.00', '50.00');
